...
"resource": {
  ...
  "predicates":[{
      ...
      "function":"_css",
      "arg0":["macro",8],
      "arg1":".track-analytics-empresa-submit"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"gtm.formSubmit"
...
return null},Fd=!1;if(H.querySelectorAll)try{var Gd=H.querySelectorAll(":root");Gd&&1==Gd.length&&Gd[0]==H.documentElement&&(Fd=!0)}catch(a){}var Cd=Fd;var Ud={},L=null,Vd=Math.random();Ud.B="GTM-TN542JN";Ud.Yb="9u1";Ud.Xh="";var Wd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Xd={__paused:!0,__tg:!0},Yd;for(Yd in Wd)Wd.hasOwnProperty(Yd)&&(Xd[Yd]=!0);var Zd="www.googletagmanager.com/gtm.js";
var $d=Zd,ae=Ha(""),be=null,ce=null,de="//www.googletagmanager.com/a?id="+Ud.B+"&cv=56",ee={},fe={},ge=function(){var a=L.sequence||1;L.sequence=a+1;return a};
...
f++}}return 0};var Kl=!!F.MutationObserver,Ll=void 0,Ml=function(a){if(!Ll){var b=function(){var c=H.body;if(c)if(Kl)(new MutationObserver(function(){for(var e=0;e<Ll.length;e++)J(Ll[e])})).observe(c,{childList:!0,subtree:!0});else{var d=!1;Zc(c,"DOMNodeInserted",function(){d||(d=!0,J(function(){d=!1;for(var e=0;e<Ll.length;e++)J(Ll[e])}))})}};Ll=[];H.body?b():J(b)}Ll.push(a)};
var Xl=function(a,b,c){function d(){var h=a();f+=e?(Ka()-e)*h.playbackRate/1E3:0;e=Ka()}var e=0,f=0;return{fc:function(h,k,l){var n=a(),p=n.He,r=void 0!==l?Math.round(l):void 0!==k?Math.round(n.He*k):Math.round(n.Ig),t=void 0!==k?Math.round(100*k):0>=p?0:Math.round(r/p*100),q=H.hidden?!1:.5<=gj(c);d();var v=Al(c,"gtm.video",[b]);v["gtm.videoProvider"]="youtube";v["gtm.videoStatus"]=h;v["gtm.videoUrl"]=n.url;v["gtm.videoTitle"]=n.title;v["gtm.videoDuration"]=Math.round(p);v["gtm.videoCurrentTime"]=
Math.round(r);v["gtm.videoElapsedTime"]=Math.round(f);v["gtm.videoPercent"]=t;v["gtm.videoVisible"]=q;ql(v)},Hh:function(){e=Ka()},Uc:function(){d()}}};var Yl=F.clearTimeout,Zl=F.setTimeout,O=function(a,b,c){if(Og()){b&&J(b)}else return Vc(a,b,c)},$l=function(){return new Date},am=function(){return F.location.href},bm=function(a){return Ze(af(a),"fragment")},cm=function(a){return $e(af(a))},dm=function(a,b){return Ke(a,b||2)},em=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=ql(a)):d=ql(a);return d},fm=function(a,b){F[a]=b},W=function(a,b,c){b&&
...
a.vtp_userId);var l=aj();(k.google_additional_params=k.google_additional_params||{}).gdpr_consent=l;f(k)||c()}else c()},e=function(){O(b,d,c)};rd()?Bd(function(){yd(C.o)?e():ud(e,C.o)},[C.o]):(Fh(),e())})}();
...
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Al(c,"gtm.click");em(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!jm("cl")){var c=W("document");Zc(c,"click",a,!0);km("cl")}J(b.vtp_gtmOnSuccess)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return gm(a.vtp_name,dm("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
[C.J,C.o])})}();
Z.a.jel=["google"],function(){(function(a){Z.__jel=a;Z.__jel.b="jel";Z.__jel.g=!0;Z.__jel.priorityOverride=0})(function(a){if(!jm("jel")){var b=W("self"),c=b.onerror;b.onerror=function(d,e,f,h,k){c&&c(d,e,f,h,k);em({event:"gtm.pageError","gtm.errorMessage":d,"gtm.errorUrl":e,"gtm.errorLineNumber":f});return!1};km("jel")}J(a.vtp_gtmOnSuccess)})}();
...
w){var y=u.getAttribute("src");if(b(y,"embed/")){if(0<y.indexOf("enablejsapi=1"))return!0;if(w)return u.setAttribute("src",c(y)),!0}return!1}function e(u,w){if(!u.getAttribute("data-gtm-yt-inspected-"+w.Cd)&&(u.setAttribute("data-gtm-yt-inspected-"+w.Cd,"true"),d(u,w.Le))){u.id||(u.id=a());var y=W("YT"),x=y.get(u.id);x||(x=new y.Player(u.id));var B=h(x,w),z={},A;for(A in B)z.Wa=A,B.hasOwnProperty(z.Wa)&&x.addEventListener(z.Wa,function(E){return function(G){return B[E.Wa](G.data)}}(z)),z={Wa:z.Wa}}}
function f(u){J(function(){function w(){for(var x=y.getElementsByTagName("iframe"),B=x.length,z=0;z<B;z++)e(x[z],u)}var y=W("document");w();Ml(w)})}function h(u,w){var y,x;function B(){ca=Xl(function(){return{url:R,title:U,He:K,Ig:u.getCurrentTime(),playbackRate:S}},w.Cd,u.getIframe());K=0;U=R="";S=1;return z}function z(T){switch(T){case t.PLAYING:K=Math.round(u.getDuration());R=u.getVideoUrl();if(u.getVideoData){var ka=u.getVideoData();U=ka?ka.title:""}S=u.getPlaybackRate();w.Cg?ca.fc("start"):ca.Uc();
I=n(w.zh,w.yh,u.getDuration());return A(T);default:return z}}function A(){oa=u.getCurrentTime();Q=$l().getTime();ca.Hh();Y();return E}function E(T){var ka;switch(T){case t.ENDED:return M(T);case t.PAUSED:ka="pause";case t.BUFFERING:var Oa=u.getCurrentTime()-oa;ka=1<Math.abs(($l().getTime()-Q)/1E3*S-Oa)?"seek":ka||"buffering";u.getCurrentTime()&&(w.Bg?ca.fc(ka):ca.Uc());V();return G;case t.UNSTARTED:return B(T);default:return E}}function G(T){switch(T){case t.ENDED:return M(T);case t.PLAYING:return A(T);
case t.UNSTARTED:return B(T);default:return G}}function M(){for(;x;){var T=y;Yl(x);T()}w.Ag&&ca.fc("complete",1);return B(t.UNSTARTED)}function P(){}function V(){x&&(Yl(x),x=0,y=P)}function Y(){if(I.length&&0!==S){var T=-1,ka;do{ka=I[0];if(ka.Ha>u.getDuration())return;T=(ka.Ha-u.getCurrentTime())/S;if(0>T&&(I.shift(),0===I.length))return}while(0>T);y=function(){x=0;y=P;0<I.length&&I[0].Ha===ka.Ha&&(I.shift(),ca.fc("progress",ka.Se,ka.We));Y()};x=Zl(y,1E3*T)}}var ca,I=[],K,R,U,S,oa,Q,ia=B(t.UNSTARTED);
x=0;y=P;return{onStateChange:function(T){ia=ia(T)},onPlaybackRateChange:function(T){oa=u.getCurrentTime();Q=$l().getTime();ca.Uc();S=T;V();Y()}}}function k(u){for(var w=u.split(","),y=w.length,x=[],B=0;B<y;B++){var z=parseInt(w[B],10);isNaN(z)||100<z||0>z||x.push(z/100)}x.sort(function(A,E){return A-E});return x}function l(u){for(var w=u.split(","),y=w.length,x=[],B=0;B<y;B++){var z=parseInt(w[B],10);isNaN(z)||0>z||x.push(z)}x.sort(function(A,E){return A-E});return x}function n(u,w,y){var x=u.map(function(A){return{Ha:A,
We:A,Se:void 0}});if(!w.length)return x;var B=w.map(function(A){return{Ha:A*y,We:void 0,Se:A}});if(!x.length)return B;var z=x.concat(B);z.sort(function(A,E){return A.Ha-E.Ha});return z}function p(u){var w=!!u.vtp_captureStart,y=!!u.vtp_captureComplete,x=!!u.vtp_capturePause,B=k(u.vtp_progressThresholdsPercent+""),z=l(u.vtp_progressThresholdsTimeInSeconds+""),A=!!u.vtp_fixMissingApi;if(w||y||x||B.length||z.length){var E={Cg:w,Ag:y,Bg:x,yh:B,zh:z,Le:A,Cd:void 0===u.vtp_uniqueTriggerId?"":u.vtp_uniqueTriggerId},
G=W("YT"),M=function(){f(E)};J(u.vtp_gtmOnSuccess);if(G)G.ready&&G.ready(M);else{var P=W("onYouTubeIframeAPIReady");fm("onYouTubeIframeAPIReady",function(){P&&P();M()});J(function(){for(var V=W("document"),Y=V.getElementsByTagName("script"),ca=Y.length,I=0;I<ca;I++){var K=Y[I].getAttribute("src");if(b(K,"iframe_api")||b(K,"player_api"))return}for(var R=V.getElementsByTagName("iframe"),U=R.length,S=0;S<U;S++)if(!v&&d(R[S],E.Le)){O("https://www.youtube.com/iframe_api");v=!0;break}})}}else J(u.vtp_gtmOnSuccess)}
var r=["www.youtube.com","www.youtube-nocookie.com"],t={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},q,v=!1;(function(u){Z.__ytl=u;Z.__ytl.b="ytl";Z.__ytl.g=!0;Z.__ytl.priorityOverride=0})(function(u){u.vtp_triggerStartOption?p(u):wh(function(){p(u)})})}();
...
Z.a.fsl=[],function(){function a(){var e=W("document"),f=c(),h=HTMLFormElement.prototype.submit;Zc(e,"click",function(k){var l=k.target;if(l&&(l=dd(l,["button","input"],100))&&("submit"==l.type||"image"==l.type)&&l.name&&ad(l,"value")){var n;l.form?l.form.tagName?n=l.form:n=H.getElementById(l.form):n=dd(l,["form"],100);n&&f.store(n,l)}},!1);Zc(e,"submit",function(k){var l=k.target;if(!l)return k.returnValue;var n=k.defaultPrevented||!1===k.returnValue,p=b(l)&&!n,r=f.get(l),t=!0;if(d(l,function(){if(t){var q;
...
h})};return{store:function(h,k){var l=f(h);l?l.button=k:e.push({form:h,button:k})},get:function(h){var k=f(h);return k?k.button:null}}}function d(e,f,h,k,l){var n=El("fsl",h?"nv.mwt":"mwt",0),p;p=h?El("fsl","nv.ids",[]):El("fsl","ids",[]);if(!p.length)return!0;var r=Al(e,"gtm.formSubmit",p),t=e.action;t&&t.tagName&&(t=e.cloneNode(!1).action);r["gtm.elementUrl"]=t;l&&(r["gtm.formSubmitElement"]=l);if(k&&n){if(!em(r,rl(f),n))return!1}else em(r,function(){},n||2E3);return!0}(function(e){Z.__fsl=e;Z.__fsl.b=
"fsl";Z.__fsl.g=!0;Z.__fsl.priorityOverride=0})(function(e){var f=e.vtp_waitForTags,h=e.vtp_checkValidation,k=Number(e.vtp_waitForTagsTimeout);if(!k||0>=k)k=2E3;var l=e.vtp_uniqueTriggerId||"0";if(f){var n=function(r){return Math.max(k,r)};Dl("fsl","mwt",n,0);h||Dl("fsl","nv.mwt",n,0)}var p=function(r){r.push(l);return r};Dl("fsl","ids",p,[]);h||Dl("fsl","nv.ids",p,[]);jm("fsl")||(a(),km("fsl"));J(e.vtp_gtmOnSuccess)})}();

...
return null},yd=!1;if(G.querySelectorAll)try{var zd=G.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==G.documentElement&&(yd=!0)}catch(a){}var vd=yd;var Pd={},I=null,Qd=Math.random();Pd.B="GTM-TN542JN";Pd.Sb="9g1";Pd.Mh="";var Rd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Sd={__paused:!0,__tg:!0},Td;for(Td in Rd)Rd.hasOwnProperty(Td)&&(Sd[Td]=!0);var Ud="www.googletagmanager.com/gtm.js";
var Vd=Ud,Wd=Ea(""),Xd=null,Yd=null,Zd="//www.googletagmanager.com/a?id="+Pd.B+"&cv=55",$d={},ae={},be=function(){var a=I.sequence||1;I.sequence=a+1;return a};
...
f++}}return 0};var Al=!!E.MutationObserver,Bl=void 0,Cl=function(a){if(!Bl){var b=function(){var c=G.body;if(c)if(Al)(new MutationObserver(function(){for(var e=0;e<Bl.length;e++)H(Bl[e])})).observe(c,{childList:!0,subtree:!0});else{var d=!1;Tc(c,"DOMNodeInserted",function(){d||(d=!0,H(function(){d=!1;for(var e=0;e<Bl.length;e++)H(Bl[e])}))})}};Bl=[];G.body?b():H(b)}Bl.push(a)};
var Nl=function(a,b,c){function d(){var h=a();f+=e?(Ha()-e)*h.playbackRate/1E3:0;e=Ha()}var e=0,f=0;return{Yb:function(h,k,l){var p=a(),n=p.ie,r=void 0!==l?Math.round(l):void 0!==k?Math.round(p.ie*k):Math.round(p.rg),t=void 0!==k?Math.round(100*k):0>=n?0:Math.round(r/n*100),q=G.hidden?!1:.5<=Yi(c);d();var u=ql(c,"gtm.video",[b]);u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=h;u["gtm.videoUrl"]=p.url;u["gtm.videoTitle"]=p.title;u["gtm.videoDuration"]=Math.round(n);u["gtm.videoCurrentTime"]=
Math.round(r);u["gtm.videoElapsedTime"]=Math.round(f);u["gtm.videoPercent"]=t;u["gtm.videoVisible"]=q;gl(u)},yh:function(){e=Ha()},Vc:function(){d()}}};var Ol=E.clearTimeout,Pl=E.setTimeout,K=function(a,b,c){if(Kg()){b&&H(b)}else return Pc(a,b,c)},Ql=function(){return new Date},Rl=function(){return E.location.href},Sl=function(a){return Ve(Xe(a),"fragment")},Tl=function(a){return We(Xe(a))},Ul=function(a,b){return Ge(a,b||2)},Vl=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=gl(a)):d=gl(a);return d},Wl=function(a,b){E[a]=b},P=function(a,b,c){b&&
...
a.vtp_userId);var l=Si();(k.google_additional_params=k.google_additional_params||{}).gdpr_consent=l;f(k)||c()}else c()},e=function(){K(b,d,c)};ld()?ud(function(){sd(C.o)?e():od(e,C.o)},[C.o]):(Ah(),e())})}();
...
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=ql(c,"gtm.click");Vl(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!$l("cl")){var c=P("document");Tc(c,"click",a,!0);am("cl")}H(b.vtp_gtmOnSuccess)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return Xl(a.vtp_name,Ul("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
Z.a.jel=["google"],function(){(function(a){Z.__jel=a;Z.__jel.b="jel";Z.__jel.g=!0;Z.__jel.priorityOverride=0})(function(a){if(!$l("jel")){var b=P("self"),c=b.onerror;b.onerror=function(d,e,f,h,k){c&&c(d,e,f,h,k);Vl({event:"gtm.pageError","gtm.errorMessage":d,"gtm.errorUrl":e,"gtm.errorLineNumber":f});return!1};am("jel")}H(a.vtp_gtmOnSuccess)})}();




Z.a.ytl=["google"],function(){function a(){var w=Math.round(1E9*Math.random())+"";return G.getElementById(w)?a():w}function b(w,y){if(!w)return!1;for(var x=0;x<t.length;x++)if(0<=w.indexOf("//"+t[x]+"/"+y))return!0;return!1}function c(w){var y=-1!==w.indexOf("?")?"&":"?";if(-1<w.indexOf("origin="))return w+y+"enablejsapi=1";if(!u){var x=P("document");u=x.location.protocol+"//"+x.location.hostname;x.location.port&&(u+=":"+x.location.port)}return w+y+"enablejsapi=1&origin="+encodeURIComponent(u)}function d(w,
y){var x=w.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(y)return w.setAttribute("src",c(x)),!0}return!1}function e(w,y){if(!w.getAttribute("data-gtm-yt-inspected-"+y.Dd)&&(w.setAttribute("data-gtm-yt-inspected-"+y.Dd,"true"),d(w,y.pe))){w.id||(w.id=a());var x=P("YT"),A=x.get(w.id);A||(A=new x.Player(w.id));var B=h(A,y),z={},D;for(D in B)z.Xa=D,B.hasOwnProperty(z.Xa)&&A.addEventListener(z.Xa,function(F){return function(J){return B[F.Xa](J.data)}}(z)),z={Xa:z.Xa}}}
function f(w){H(function(){function y(){for(var A=x.getElementsByTagName("iframe"),B=A.length,z=0;z<B;z++)e(A[z],w)}var x=P("document");y();Cl(y)})}function h(w,y){var x,A;function B(){M=Nl(function(){return{url:Q,title:ca,ie:L,rg:w.getCurrentTime(),playbackRate:U}},y.Dd,w.getIframe());L=0;ca=Q="";U=1;return z}function z(X){switch(X){case q.PLAYING:L=Math.round(w.getDuration());Q=w.getVideoUrl();if(w.getVideoData){var ka=w.getVideoData();ca=ka?ka.title:""}U=w.getPlaybackRate();y.kg?M.Yb("start"):
M.Vc();N=p(y.qh,y.ph,w.getDuration());return D(X);default:return z}}function D(){S=w.getCurrentTime();W=Ql().getTime();M.yh();ra();return F}function F(X){var ka;switch(X){case q.ENDED:return O(X);case q.PAUSED:ka="pause";case q.BUFFERING:var kc=w.getCurrentTime()-S;ka=1<Math.abs((Ql().getTime()-W)/1E3*U-kc)?"seek":ka||"buffering";w.getCurrentTime()&&(y.jg?M.Yb(ka):M.Vc());V();return J;case q.UNSTARTED:return B(X);default:return F}}function J(X){switch(X){case q.ENDED:return O(X);case q.PLAYING:return D(X);
case q.UNSTARTED:return B(X);default:return J}}function O(){for(;A;){var X=x;Ol(A);X()}y.ig&&M.Yb("complete",1);return B(q.UNSTARTED)}function T(){}function V(){A&&(Ol(A),A=0,x=T)}function ra(){if(N.length&&0!==U){var X=-1,ka;do{ka=N[0];if(ka.Ia>w.getDuration())return;X=(ka.Ia-w.getCurrentTime())/U;if(0>X&&(N.shift(),0===N.length))return}while(0>X);x=function(){A=0;x=T;0<N.length&&N[0].Ia===ka.Ia&&(N.shift(),M.Yb("progress",ka.He,ka.Oe));ra()};A=Pl(x,1E3*X)}}var M,N=[],L,Q,ca,U,S,W,va=B(q.UNSTARTED);
A=0;x=T;return{onStateChange:function(X){va=va(X)},onPlaybackRateChange:function(X){S=w.getCurrentTime();W=Ql().getTime();M.Vc();U=X;V();ra()}}}function k(w){for(var y=w.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||100<z||0>z||A.push(z/100)}A.sort(function(D,F){return D-F});return A}function l(w){for(var y=w.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||0>z||A.push(z)}A.sort(function(D,F){return D-F});return A}function p(w,y,x){var A=w.map(function(D){return{Ia:D,
Oe:D,He:void 0}});if(!y.length)return A;var B=y.map(function(D){return{Ia:D*x,Oe:void 0,He:D}});if(!A.length)return B;var z=A.concat(B);z.sort(function(D,F){return D.Ia-F.Ia});return z}function n(w){w.vtp_triggerStartOption?r(w):rh(function(){r(w)})}function r(w){var y=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,A=!!w.vtp_capturePause,B=k(w.vtp_progressThresholdsPercent+""),z=l(w.vtp_progressThresholdsTimeInSeconds+""),D=!!w.vtp_fixMissingApi;if(y||x||A||B.length||z.length){var F={kg:y,ig:x,jg:A,
ph:B,qh:z,pe:D,Dd:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},J=P("YT"),O=function(){f(F)};H(w.vtp_gtmOnSuccess);if(J)J.ready&&J.ready(O);else{var T=P("onYouTubeIframeAPIReady");Wl("onYouTubeIframeAPIReady",function(){T&&T();O()});H(function(){for(var V=P("document"),ra=V.getElementsByTagName("script"),M=ra.length,N=0;N<M;N++){var L=ra[N].getAttribute("src");if(b(L,"iframe_api")||b(L,"player_api"))return}for(var Q=V.getElementsByTagName("iframe"),ca=Q.length,U=0;U<ca;U++)if(!v&&d(Q[U],
F.pe)){K("https://www.youtube.com/iframe_api");v=!0;break}})}}else H(w.vtp_gtmOnSuccess)}var t=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},u,v=!1;Z.__ytl=n;Z.__ytl.b="ytl";Z.__ytl.g=!0;Z.__ytl.priorityOverride=0}();

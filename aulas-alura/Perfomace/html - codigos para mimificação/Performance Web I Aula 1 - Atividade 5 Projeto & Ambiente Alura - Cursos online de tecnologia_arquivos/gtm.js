...
return null},Cd=!1;if(I.querySelectorAll)try{var Dd=I.querySelectorAll(":root");Dd&&1==Dd.length&&Dd[0]==I.documentElement&&(Cd=!0)}catch(a){}var zd=Cd;var Rd={},Q=null,Sd=Math.random();Rd.C="GTM-TN542JN";Rd.Vb="8q1";Rd.Nh="";var Td={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Ud="www.googletagmanager.com/gtm.js";
var Vd=Ud,Wd=null,Xd=null,Yd="//www.googletagmanager.com/a?id="+Rd.C+"&cv=55",Zd={},$d={},ae=function(){var a=Q.sequence||1;Q.sequence=a+1;return a};
...
v("gdpr_consent",Ki());"1"===Pf(!1)._up&&v("gtm_up","1");v("gclid",Ni(b,f));v("gclsrc",h);v("gtm",gi(!c));var A=w+"/pagead/landing?"+u.join("&");ad(A)}}var e=ig(),f=e.gclid||"",h=e.gclsrc,k=e.dclid||"",l=!a&&(!f||h&&"aw.ds"!==h?!1:!0),p=nd();if(l||p){var n=""+gf();p?wd(function(){d();ud(D.o)||qd(function(){return d(!0)},D.o)},[D.o]):d()}}function Ni(a,b){var c=a&&!ud(D.o);return b&&c?"0":b}var zj=function(){var a=!0;Li(7)&&Li(9)&&Li(10)||(a=!1);var b=!0;b&&!yj()&&(a=!1);return a},yj=function(){var a=!0;Li(3)&&Li(4)||(a=!1);return a};function Tj(){var a=Q;return a.gcq=a.gcq||new Uj}
...
Dl(a,b,c)()});return Cl(function(f){e=!0;for(var h={Za:0};h.Za<f.length;h={Za:h.Za},h.Za++)L(function(k){return function(){return a(f[k.Za])}}(h))},b,c)}return H.setInterval(Dl(a,b,c),1E3)},Fl=function(a){Bl?0<=a&&a<Al.length&&Al[a]&&(Al[a].disconnect(),Al[a]=void 0):H.clearInterval(a)};
var Gl=function(a,b,c){function d(){var h=a();f+=e?(Ja()-e)*h.playbackRate/1E3:0;e=Ja()}var e=0,f=0;return{ac:function(h,k,l){var p=a(),n=p.je,r=void 0!==l?Math.round(l):void 0!==k?Math.round(p.je*k):Math.round(p.ug),t=void 0!==k?Math.round(100*k):0>=n?0:Math.round(r/n*100),q=I.hidden?!1:.5<=yl(c);d();var u=al(c,"gtm.video",[b]);u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=h;u["gtm.videoUrl"]=p.url;u["gtm.videoTitle"]=p.title;u["gtm.videoDuration"]=Math.round(n);u["gtm.videoCurrentTime"]=
Math.round(r);u["gtm.videoElapsedTime"]=Math.round(f);u["gtm.videoPercent"]=t;u["gtm.videoVisible"]=q;Qk(u)},zh:function(){e=Ja()},Vc:function(){d()}}};var Hl=H.clearTimeout,Il=H.setTimeout,W=function(a,b,c){if(Eg()){b&&L(b)}else return Rc(a,b,c)},Jl=function(){return new Date},Kl=function(){return H.location.href},Ll=function(a){return Pe(Re(a),"fragment")},Ml=function(a){return Qe(Re(a))},Nl=function(a,b){return Ce(a,b||2)},Ol=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=Qk(a)):d=Qk(a);return d},Pl=function(a,b){H[a]=b},X=function(a,b,c){b&&
...
var p=Ki();(l.google_additional_params=l.google_additional_params||{}).gdpr_consent=p;f(l)||c()}else c()},e=function(){W(b,d,c)};nd()?wd(function(){ud(D.o)?e():qd(e,D.o)},[D.o]):(rh(),e())})}();
...
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=al(c,"gtm.click");Ol(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!Tl("cl")){var c=X("document");Vc(c,"click",a,!0);Ul("cl")}L(b.vtp_gtmOnSuccess)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return Ql(a.vtp_name,Nl("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
if(wa(A)){var B="",y="";n.vtp_setTrackerName&&"string"==typeof n.vtp_trackerName?""!==n.vtp_trackerName&&(y=n.vtp_trackerName,B=y+"."):(y="gtm"+ae(),B=y+".");var C=function(ja){var R=[].slice.call(arguments,0);R[0]=B+R[0];A.apply(window,R)},G=function(ja,R){return void 0===R?R:ja(R)},J=function(ja,R){if(R)for(var Ua in R)R.hasOwnProperty(Ua)&&C("set",ja+Ua,R[Ua])},P=function(){},U={name:y};k(x,U,!0);var N=n.vtp_trackingId||t.trackingId;A("create",N,U);C("set","&gtm",gi(!0));nd()&&(C("set","&gcs",vd()),a(N,n));x._x_19&&(null==Oc&&delete x._x_19,x._x_20&&!c[y]&&(c[y]=!0,A(Ch(y,String(x._x_20)))));n.vtp_enableRecaptcha&&
...
z){var x=w.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(z)return w.setAttribute("src",c(x)),!0}return!1}function e(w,z){if(!w.getAttribute("data-gtm-yt-inspected-"+z.Cd)&&(w.setAttribute("data-gtm-yt-inspected-"+z.Cd,"true"),d(w,z.qe))){w.id||(w.id=a());var x=X("YT"),A=x.get(w.id);A||(A=new x.Player(w.id));var B=h(A,z),y={},C;for(C in B)y.$a=C,B.hasOwnProperty(y.$a)&&A.addEventListener(y.$a,function(G){return function(J){return B[G.$a](J.data)}}(y)),y={$a:y.$a}}}
function f(w){L(function(){function z(){for(var A=x.getElementsByTagName("iframe"),B=A.length,y=0;y<B;y++)e(A[y],w)}var x=X("document");z();ml(z)})}function h(w,z){var x,A;function B(){aa=Gl(function(){return{url:O,title:T,je:K,ug:w.getCurrentTime(),playbackRate:S}},z.Cd,w.getIframe());K=0;T=O="";S=1;return y}function y(ca){switch(ca){case q.PLAYING:K=Math.round(w.getDuration());O=w.getVideoUrl();if(w.getVideoData){var ua=w.getVideoData();T=ua?ua.title:""}S=w.getPlaybackRate();z.mg?aa.ac("start"):
aa.Vc();M=p(z.rh,z.qh,w.getDuration());return C(ca);default:return y}}function C(){ra=w.getCurrentTime();sa=Jl().getTime();aa.zh();ma();return G}function G(ca){var ua;switch(ca){case q.ENDED:return P(ca);case q.PAUSED:ua="pause";case q.BUFFERING:var jc=w.getCurrentTime()-ra;ua=1<Math.abs((Jl().getTime()-sa)/1E3*S-jc)?"seek":ua||"buffering";w.getCurrentTime()&&(z.lg?aa.ac(ua):aa.Vc());N();return J;case q.UNSTARTED:return B(ca);default:return G}}function J(ca){switch(ca){case q.ENDED:return P(ca);case q.PLAYING:return C(ca);
case q.UNSTARTED:return B(ca);default:return J}}function P(){for(;A;){var ca=x;Hl(A);ca()}z.kg&&aa.ac("complete",1);return B(q.UNSTARTED)}function U(){}function N(){A&&(Hl(A),A=0,x=U)}function ma(){if(M.length&&0!==S){var ca=-1,ua;do{ua=M[0];if(ua.Ja>w.getDuration())return;ca=(ua.Ja-w.getCurrentTime())/S;if(0>ca&&(M.shift(),0===M.length))return}while(0>ca);x=function(){A=0;x=U;0<M.length&&M[0].Ja===ua.Ja&&(M.shift(),aa.ac("progress",ua.Ie,ua.Pe));ma()};A=Il(x,1E3*ca)}}var aa,M=[],K,O,T,S,ra,sa,Ta=
B(q.UNSTARTED);A=0;x=U;return{onStateChange:function(ca){Ta=Ta(ca)},onPlaybackRateChange:function(ca){ra=w.getCurrentTime();sa=Jl().getTime();aa.Vc();S=ca;N();ma()}}}function k(w){for(var z=w.split(","),x=z.length,A=[],B=0;B<x;B++){var y=parseInt(z[B],10);isNaN(y)||100<y||0>y||A.push(y/100)}A.sort(function(C,G){return C-G});return A}function l(w){for(var z=w.split(","),x=z.length,A=[],B=0;B<x;B++){var y=parseInt(z[B],10);isNaN(y)||0>y||A.push(y)}A.sort(function(C,G){return C-G});return A}function p(w,
z,x){var A=w.map(function(C){return{Ja:C,Pe:C,Ie:void 0}});if(!z.length)return A;var B=z.map(function(C){return{Ja:C*x,Pe:void 0,Ie:C}});if(!A.length)return B;var y=A.concat(B);y.sort(function(C,G){return C.Ja-G.Ja});return y}function n(w){w.vtp_triggerStartOption?r(w):ih(function(){r(w)})}function r(w){var z=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,A=!!w.vtp_capturePause,B=k(w.vtp_progressThresholdsPercent+""),y=l(w.vtp_progressThresholdsTimeInSeconds+""),C=!!w.vtp_fixMissingApi;if(z||x||A||
B.length||y.length){var G={mg:z,kg:x,lg:A,qh:B,rh:y,qe:C,Cd:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},J=X("YT"),P=function(){f(G)};L(w.vtp_gtmOnSuccess);if(J)J.ready&&J.ready(P);else{var U=X("onYouTubeIframeAPIReady");Pl("onYouTubeIframeAPIReady",function(){U&&U();P()});L(function(){for(var N=X("document"),ma=N.getElementsByTagName("script"),aa=ma.length,M=0;M<aa;M++){var K=ma[M].getAttribute("src");if(b(K,"iframe_api")||b(K,"player_api"))return}for(var O=N.getElementsByTagName("iframe"),
T=O.length,S=0;S<T;S++)if(!v&&d(O[S],G.qe)){W("https://www.youtube.com/iframe_api");v=!0;break}})}}else L(w.vtp_gtmOnSuccess)}var t=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},u,v=!1;Z.__ytl=n;Z.__ytl.b="ytl";Z.__ytl.g=!0;Z.__ytl.priorityOverride=0}();
...
Z.a.fsl=[],function(){function a(){var e=X("document"),f=c(),h=HTMLFormElement.prototype.submit;Vc(e,"click",function(k){var l=k.target;if(l&&(l=$c(l,["button","input"],100))&&("submit"==l.type||"image"==l.type)&&l.name&&Xc(l,"value")){var p;l.form?l.form.tagName?p=l.form:p=I.getElementById(l.form):p=$c(l,["form"],100);p&&f.store(p,l)}},!1);Vc(e,"submit",function(k){var l=k.target;if(!l)return k.returnValue;var p=k.defaultPrevented||!1===k.returnValue,n=b(l)&&!p,r=f.get(l),t=!0;if(d(l,function(){if(t){var q;
r&&(q=e.createElement("input"),q.type="hidden",q.name=r.name,q.value=r.value,l.appendChild(q));h.call(l);q&&l.removeChild(q)}},p,n,r))t=!1;else return p||(k.preventDefault&&k.preventDefault(),k.returnValue=!1),!1;return k.returnValue},!1);HTMLFormElement.prototype.submit=function(){var k=this,l=b(k),p=!0;d(k,function(){p&&h.call(k)},!1,l)&&(h.call(k),p=!1)}}function b(e){var f=e.target;return f&&"_self"!==f&&"_parent"!==f&&"_top"!==f?!1:!0}function c(){var e=[],f=function(h){return Aa(e,function(k){return k.form===
h})};return{store:function(h,k){var l=f(h);l?l.button=k:e.push({form:h,button:k})},get:function(h){var k=f(h);return k?k.button:null}}}function d(e,f,h,k,l){var p=el("fsl",h?"nv.mwt":"mwt",0),n;n=h?el("fsl","nv.ids",[]):el("fsl","ids",[]);if(!n.length)return!0;var r=al(e,"gtm.formSubmit",n),t=e.action;t&&t.tagName&&(t=e.cloneNode(!1).action);r["gtm.elementUrl"]=t;l&&(r["gtm.formSubmitElement"]=l);if(k&&p){if(!Ol(r,Rk(f),p))return!1}else Ol(r,function(){},p||2E3);return!0}(function(e){Z.__fsl=e;Z.__fsl.b=
"fsl";Z.__fsl.g=!0;Z.__fsl.priorityOverride=0})(function(e){var f=e.vtp_waitForTags,h=e.vtp_checkValidation,k=Number(e.vtp_waitForTagsTimeout);if(!k||0>=k)k=2E3;var l=e.vtp_uniqueTriggerId||"0";if(f){var p=function(r){return Math.max(k,r)};dl("fsl","mwt",p,0);h||dl("fsl","nv.mwt",p,0)}var n=function(r){r.push(l);return r};dl("fsl","ids",n,[]);h||dl("fsl","nv.ids",n,[]);Tl("fsl")||(a(),Ul("fsl"));L(e.vtp_gtmOnSuccess)})}();

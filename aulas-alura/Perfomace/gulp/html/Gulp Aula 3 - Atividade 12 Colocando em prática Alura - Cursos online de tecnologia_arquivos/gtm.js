...
return null},yd=!1;if(H.querySelectorAll)try{var Bd=H.querySelectorAll(":root");Bd&&1==Bd.length&&Bd[0]==H.documentElement&&(yd=!0)}catch(a){}var vd=yd;var Pd={},L=null,Qd=Math.random();Pd.B="GTM-TN542JN";Pd.Sb="990";Pd.Mh="";var Rd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Sd={__paused:!0,__tg:!0},Td;for(Td in Rd)Rd.hasOwnProperty(Td)&&(Sd[Td]=!0);var Ud="www.googletagmanager.com/gtm.js";
var Vd=Ud,Wd=null,Xd=null,Yd="//www.googletagmanager.com/a?id="+Pd.B+"&cv=55",Zd={},$d={},ae=function(){var a=L.sequence||1;L.sequence=a+1;return a};
...
Bl(a,b,c)()});return Al(function(f){e=!0;for(var h={Wa:0};h.Wa<f.length;h={Wa:h.Wa},h.Wa++)I(function(k){return function(){return a(f[k.Wa])}}(h))},b,c)}return F.setInterval(Bl(a,b,c),1E3)},Dl=function(a){zl?0<=a&&a<yl.length&&yl[a]&&(yl[a].disconnect(),yl[a]=void 0):F.clearInterval(a)};
var El=function(a,b,c){function d(){var h=a();f+=e?(Ja()-e)*h.playbackRate/1E3:0;e=Ja()}var e=0,f=0;return{Yb:function(h,k,l){var p=a(),n=p.he,r=void 0!==l?Math.round(l):void 0!==k?Math.round(p.he*k):Math.round(p.rg),t=void 0!==k?Math.round(100*k):0>=n?0:Math.round(r/n*100),q=H.hidden?!1:.5<=wl(c);d();var u=Zk(c,"gtm.video",[b]);u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=h;u["gtm.videoUrl"]=p.url;u["gtm.videoTitle"]=p.title;u["gtm.videoDuration"]=Math.round(n);u["gtm.videoCurrentTime"]=
Math.round(r);u["gtm.videoElapsedTime"]=Math.round(f);u["gtm.videoPercent"]=t;u["gtm.videoVisible"]=q;Pk(u)},yh:function(){e=Ja()},Vc:function(){d()}}};var Fl=F.clearTimeout,Gl=F.setTimeout,W=function(a,b,c){if(Hg()){b&&I(b)}else return Pc(a,b,c)},Hl=function(){return new Date},Il=function(){return F.location.href},Jl=function(a){return Se(Ue(a),"fragment")},Kl=function(a){return Te(Ue(a))},Ll=function(a,b){return Fe(a,b||2)},Ml=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=Pk(a)):d=Pk(a);return d},Nl=function(a,b){F[a]=b},X=function(a,b,c){b&&
...
a.vtp_userId);var l=Ni();(k.google_additional_params=k.google_additional_params||{}).gdpr_consent=l;f(k)||c()}else c()},e=function(){W(b,d,c)};ld()?ud(function(){sd(D.o)?e():od(e,D.o)},[D.o]):(vh(),e())})}();
...
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Zk(c,"gtm.click");Ml(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!Rl("cl")){var c=X("document");Tc(c,"click",a,!0);Sl("cl")}I(b.vtp_gtmOnSuccess)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return Ol(a.vtp_name,Ll("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
Z.a.jel=["google"],function(){(function(a){Z.__jel=a;Z.__jel.b="jel";Z.__jel.g=!0;Z.__jel.priorityOverride=0})(function(a){if(!Rl("jel")){var b=X("self"),c=b.onerror;b.onerror=function(d,e,f,h,k){c&&c(d,e,f,h,k);Ml({event:"gtm.pageError","gtm.errorMessage":d,"gtm.errorUrl":e,"gtm.errorLineNumber":f});return!1};Sl("jel")}I(a.vtp_gtmOnSuccess)})}();
...
z){var x=w.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(z)return w.setAttribute("src",c(x)),!0}return!1}function e(w,z){if(!w.getAttribute("data-gtm-yt-inspected-"+z.Cd)&&(w.setAttribute("data-gtm-yt-inspected-"+z.Cd,"true"),d(w,z.oe))){w.id||(w.id=a());var x=X("YT"),A=x.get(w.id);A||(A=new x.Player(w.id));var B=h(A,z),y={},C;for(C in B)y.Xa=C,B.hasOwnProperty(y.Xa)&&A.addEventListener(y.Xa,function(G){return function(J){return B[G.Xa](J.data)}}(y)),y={Xa:y.Xa}}}
function f(w){I(function(){function z(){for(var A=x.getElementsByTagName("iframe"),B=A.length,y=0;y<B;y++)e(A[y],w)}var x=X("document");z();kl(z)})}function h(w,z){var x,A;function B(){aa=El(function(){return{url:U,title:R,he:K,rg:w.getCurrentTime(),playbackRate:N}},z.Cd,w.getIframe());K=0;R=U="";N=1;return y}function y(ca){switch(ca){case q.PLAYING:K=Math.round(w.getDuration());U=w.getVideoUrl();if(w.getVideoData){var ta=w.getVideoData();R=ta?ta.title:""}N=w.getPlaybackRate();z.kg?aa.Yb("start"):
aa.Vc();M=p(z.qh,z.ph,w.getDuration());return C(ca);default:return y}}function C(){fa=w.getCurrentTime();ra=Hl().getTime();aa.yh();O();return G}function G(ca){var ta;switch(ca){case q.ENDED:return P(ca);case q.PAUSED:ta="pause";case q.BUFFERING:var kc=w.getCurrentTime()-fa;ta=1<Math.abs((Hl().getTime()-ra)/1E3*N-kc)?"seek":ta||"buffering";w.getCurrentTime()&&(z.jg?aa.Yb(ta):aa.Vc());V();return J;case q.UNSTARTED:return B(ca);default:return G}}function J(ca){switch(ca){case q.ENDED:return P(ca);case q.PLAYING:return C(ca);
case q.UNSTARTED:return B(ca);default:return J}}function P(){for(;A;){var ca=x;Fl(A);ca()}z.ig&&aa.Yb("complete",1);return B(q.UNSTARTED)}function T(){}function V(){A&&(Fl(A),A=0,x=T)}function O(){if(M.length&&0!==N){var ca=-1,ta;do{ta=M[0];if(ta.Ia>w.getDuration())return;ca=(ta.Ia-w.getCurrentTime())/N;if(0>ca&&(M.shift(),0===M.length))return}while(0>ca);x=function(){A=0;x=T;0<M.length&&M[0].Ia===ta.Ia&&(M.shift(),aa.Yb("progress",ta.Ge,ta.Ne));O()};A=Gl(x,1E3*ca)}}var aa,M=[],K,U,R,N,fa,ra,Ia=B(q.UNSTARTED);
A=0;x=T;return{onStateChange:function(ca){Ia=Ia(ca)},onPlaybackRateChange:function(ca){fa=w.getCurrentTime();ra=Hl().getTime();aa.Vc();N=ca;V();O()}}}function k(w){for(var z=w.split(","),x=z.length,A=[],B=0;B<x;B++){var y=parseInt(z[B],10);isNaN(y)||100<y||0>y||A.push(y/100)}A.sort(function(C,G){return C-G});return A}function l(w){for(var z=w.split(","),x=z.length,A=[],B=0;B<x;B++){var y=parseInt(z[B],10);isNaN(y)||0>y||A.push(y)}A.sort(function(C,G){return C-G});return A}function p(w,z,x){var A=
w.map(function(C){return{Ia:C,Ne:C,Ge:void 0}});if(!z.length)return A;var B=z.map(function(C){return{Ia:C*x,Ne:void 0,Ge:C}});if(!A.length)return B;var y=A.concat(B);y.sort(function(C,G){return C.Ia-G.Ia});return y}function n(w){w.vtp_triggerStartOption?r(w):mh(function(){r(w)})}function r(w){var z=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,A=!!w.vtp_capturePause,B=k(w.vtp_progressThresholdsPercent+""),y=l(w.vtp_progressThresholdsTimeInSeconds+""),C=!!w.vtp_fixMissingApi;if(z||x||A||B.length||
y.length){var G={kg:z,ig:x,jg:A,ph:B,qh:y,oe:C,Cd:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},J=X("YT"),P=function(){f(G)};I(w.vtp_gtmOnSuccess);if(J)J.ready&&J.ready(P);else{var T=X("onYouTubeIframeAPIReady");Nl("onYouTubeIframeAPIReady",function(){T&&T();P()});I(function(){for(var V=X("document"),O=V.getElementsByTagName("script"),aa=O.length,M=0;M<aa;M++){var K=O[M].getAttribute("src");if(b(K,"iframe_api")||b(K,"player_api"))return}for(var U=V.getElementsByTagName("iframe"),R=U.length,
...
h})};return{store:function(h,k){var l=f(h);l?l.button=k:e.push({form:h,button:k})},get:function(h){var k=f(h);return k?k.button:null}}}function d(e,f,h,k,l){var p=cl("fsl",h?"nv.mwt":"mwt",0),n;n=h?cl("fsl","nv.ids",[]):cl("fsl","ids",[]);if(!n.length)return!0;var r=Zk(e,"gtm.formSubmit",n),t=e.action;t&&t.tagName&&(t=e.cloneNode(!1).action);r["gtm.elementUrl"]=t;l&&(r["gtm.formSubmitElement"]=l);if(k&&p){if(!Ml(r,Qk(f),p))return!1}else Ml(r,function(){},p||2E3);return!0}(function(e){Z.__fsl=e;Z.__fsl.b=
"fsl";Z.__fsl.g=!0;Z.__fsl.priorityOverride=0})(function(e){var f=e.vtp_waitForTags,h=e.vtp_checkValidation,k=Number(e.vtp_waitForTagsTimeout);if(!k||0>=k)k=2E3;var l=e.vtp_uniqueTriggerId||"0";if(f){var p=function(r){return Math.max(k,r)};bl("fsl","mwt",p,0);h||bl("fsl","nv.mwt",p,0)}var n=function(r){r.push(l);return r};bl("fsl","ids",n,[]);h||bl("fsl","nv.ids",n,[]);Rl("fsl")||(a(),Sl("fsl"));I(e.vtp_gtmOnSuccess)})}();
